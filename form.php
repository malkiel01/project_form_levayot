<?php
// form.php - גרסה מתוקנת עם תיקון בעיות שיתוף והרשאות
...
if (isset($_GET['link'])) {
    ...
    if ($linkData) {
        ...
        if ($accessGranted) {
            ...
            // **תיקון הבעיה השנייה - קביעת viewOnly לפי הרשאות הקישור**
            $viewOnly = !$linkData['can_edit'];
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="link-access-notice">
                ...
                <?php else: ?>
                    <br><small><i class="fas fa-edit"></i> יש לך הרשאה לערוך</small>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            ...
            <form method="POST" id="deceasedForm" novalidate>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-center">
                        ...
                        <!-- כפתור שיתוף - **תיקון הבעיה הראשונה** -->
                        <?php if (!$isNewForm && isUserLoggedIn()): ?>
    ...
    <!-- **תיקון הבעיה הראשונה - החזרת המודלים לשיתוף** -->
    ...
    <script>
        ...
        // **פונקציות השיתוף - תיקון הבעיה הראשונה**
