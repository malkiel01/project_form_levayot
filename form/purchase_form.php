...
<body>
    <?php renderLoadingOverlay2(); ?>
    <?php renderUserStatusIndicator2($isLinkAccess, $viewOnly); ?>
    
    <div class="container">
        <div class="form-container">
            <?php renderPurchaseFormHeader2($isNewForm, $formUuid, $isLinkAccess, $viewOnly); ?>
            
            <?php if (!$isNewForm): ?>
                <?php renderPurchaseFormStatus2($formData); ?>
            <?php endif; ?>
            
            <?php renderMessages2($successMessage ?? null, $errorMessage ?? null); ?>
            <?php renderProgressBar2($formData['progress_percentage'] ?? 0); ?>
            <?php renderMissingFieldsAlert2(); ?>
    ...
    <?php renderPurchaseShareModals2(); ?>
    ...
    <?php renderPurchaseFormScripts2(); ?>
